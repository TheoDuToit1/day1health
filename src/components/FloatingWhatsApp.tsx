// Simple, inactive floating WhatsApp button (bottom-left)
// Will be linked later – currently no navigation/action
export default function FloatingWhatsApp() {
  return (
    <button
      ...
      aria-disabled="true"
      className="fixed bottom-4 right-4 z-50 h-12 w-12 rounded-full flex items-center justify-center shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-green-400 cursor-not-allowed select-none"
