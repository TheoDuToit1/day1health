...
const demoEmails = [
  ...
  { label: 'New Claims Submission', email: '1Doctorclaims@Day1.co.za' },
  { label: 'Membership-Related Queries', email: 'admin@Day1.co.za' },
  { label: 'Claims Queries', email: 'claimsqueries@Day1.co.za' },
  { label: 'General Queries', email: 'info@day1.co.za' },
  { label: 'Provider Remittance Requests', email: 'remittance@Day1.co.za' },
