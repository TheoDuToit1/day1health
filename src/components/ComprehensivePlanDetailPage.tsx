...
const ComprehensivePlanDetailPage: React.FC = () => {
  ...
  const pageTitle = `Comprehensive - ${displayCategory}`;
  ...
  const updateUrl = (nextVariant: string, nextChildren?: number, nextQty?: number) => {
    ...
    const path = `/comprehensive/${sub}/${nextVariant}`;
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className={`mt-1 text-sm ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                        Combined day-to-day and hospital benefits
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <div className={`text-lg font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>Comprehensive</div>
                        </div>
                        <RollingNumber
                          value={currentPrice}
                          prefix="R"
